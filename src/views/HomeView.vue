<template>
  <div class="box-outer">
    ...
    <div>
      <p>
        Hi, My name is Muhammed Rashid & I am a Fullstack developer from Mumbai,
        India, working in Mak Enterprises with 4+ years of rich experience.
      </p>
      <p>
      ...
      >
        <div class="case-item box box--s2 box-inner">
          <img class="case-item__icon" :src="row.image" alt="" />
          <div>
    ...
    listJobs() {
      this.myJobs = [
        ...
        },
        {
          ...
          content: "The most modern and high-quality design made at a professional level.",
        }
      ];
    },
  },
