  ...
  <div class="box-outer">
    ...
    <div>
      ...
      <p>
        ...
        60+ web applications. My expertise spans across E-commerce, CMS, CRM,
        HRMS, LMS, ERP, WordPress, Static, and custom websites, covering both
    ...
    return {
      ...
      AboutMePoints: [
        ...
        },
        {
          id: "8",
          content:
            "Currently working as a fullstack developer with NexGeno Technoly.",
        },
      ],
    };
  },
